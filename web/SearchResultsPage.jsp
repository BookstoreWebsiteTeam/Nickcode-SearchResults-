...
<html>
    ...
    <body>
        ...
        /*Searchlist sr= new Searchlist((ArrayList<Book>)request.getSession().getAttribute("result"));
        sr.getResults().sortByTitle();*/
        SearchResults sr = new SearchResults(Searchlist);
